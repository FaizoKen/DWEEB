...
/** Magnifying glass — for search inputs. */
...
/** Stacked layers — the "templates / gallery" glyph. */
export const TemplateIcon = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
/** Two people — collaboration / co-editing (the Discord Activity hand-off). */
...
/** Single puzzle piece — the universal "plugin / extension" glyph. */
export const PuzzleIcon = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
/** Film frame — the intro video ("Watch the intro" in the More menu). */
export const FilmIcon = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
