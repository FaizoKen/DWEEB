...
impl ConnectError {
    ...
    /// so an admin opening it for a server this deployment's bot was never
    /// invited to is routine — it must not page anyone. Neither may Discord
    /// merely being slow: on 2026-08-20 one 2200 ms timeout on self-role's twin of this route paged
    /// the maintainer over nothing anyone could act on.
...
mod tests {
    ...
    /// deployment's bot was never invited to used to answer 502 and page the
