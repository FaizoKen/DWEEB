...
/// The union every shared-bot invite must request. Currently just Manage Roles.
const SHARED_BOT_PERMISSIONS: u64 = MANAGE_ROLES;
...
mod tests {
    ...
    fn rewrites_a_too_narrow_permissions_to_the_union() {
        ...
        assert_eq!(perms_of(&out).as_deref(), Some("268435456"));
    }
